...
void merge2SortedArrays(int b[], int si, int ei)
{
...
void mergeSort(int b[], int si, int ei)
{
    if(si>=ei)
    {
        return;
    ...
    mergeSort(b, si, mid);
    mergeSort(b, mid+1, ei);

    merge2SortedArrays(b, si, ei);
}
                ...
                else if(e.type==SDL_KEYDOWN)
                {
                    switch(e.key.keysym.sym)
                    {
                        ...
                        case(SDLK_0):
                            ...
                            complete=false;
                            loadArr();
                            cout<<"\nNEW RANDOM LIST HAS BEEN  GENERATED.\n";
                            break;
                        case(SDLK_1):
                            loadArr();
                            cout<<"\nSELECTION SORT HAS BEEN STARTED.\n";
                            complete=false;
                            selectionSort();
                            complete=true;
                            cout<<"\nSELECTION SORT HAS BEEN COMPLETE.\n";
                            break;
                        case(SDLK_2):
                            loadArr();
                            cout<<"\nINSERTION SORT HAS BEEN STARTED.\n";
                            complete=false;
                            insertionSort();
                            complete=true;
                            cout<<"\nINSERTION SORT HAS BEEN COMPLETE.\n";
                            break;
                        case(SDLK_3):
                            loadArr();
                            cout<<"\nBUBBLE SORT HAS BEEN STARTED.\n";
                            complete=false;
                            bubbleSort();
                            complete=true;
                            cout<<"\nBUBBLE SORT HAS BEEN COMPLETE.\n";
                            break;
                        case(SDLK_4):
                            loadArr();
                            cout<<"\nMERGE SORT HAS BEEN STARTED.\n";
                            complete=false;
                            mergeSort(arr, 0, arrSize-1);
                            complete=true;
                            cout<<"\nMERGE SORT HAS BEEN COMPLETE.\n";
                            break;
                        case(SDLK_5):
                            loadArr();
                            cout<<"\nQUICK SORT HAS BEEN STARTED.\n";
                            complete=false;
                            quickSort(arr, 0, arrSize-1);
                            complete=true;
                            cout<<"\nQUICK SORT HAS BEEN  COMPLETE.\n";
                            break;
                        case(SDLK_6):
                            loadArr();
                            cout<<"\nHEAP SORT HAS BEEN STARTED.\n";
                            complete=false;
                            inplaceHeapSort(arr, arrSize);
                            complete=true;
                            cout<<"\n HEAP SORT HAS BEEN COMPLETE.\n";
                            break;
                    }
                }
            }
...
bool controls()
{
    cout <<"WARNING: Please give a new command only after the current command's execution is done.Giving irrespective commands causes the failure of the program\n\n"
         ...
         <<"    Use A to exit out of Sorting Visualizer\n\n"
